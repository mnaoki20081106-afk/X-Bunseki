...
def _write_hits(surviving: list[dict], candidates: list[dict], started_iso: str, watch_state: dict | None = None):
    ...
    for row in (watch_state or {}).values():
        ...
        trending.append({
            ...
            "author_name": row.get("author_name") or row.get("author_handle"),
            ...
            "quotes": row.get("last_quotes"), "bookmarks": row.get("last_bookmarks"),
        ...
        "early_posts": [
            {
                ...
                "author_name": p.get("author_name") or p.get("author_handle"),
